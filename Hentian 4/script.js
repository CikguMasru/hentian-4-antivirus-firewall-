...
function autoFitNama(teks) {
    ...
    if(teks.length > 18) saiz = 50;
    if(teks.length > 24) saiz = 46;
    if(teks.length > 30) saiz = 42;
    if(teks.length > 36) saiz = 38;
    if(teks.length > 42) saiz = 34;
    if(teks.length > 50) saiz = 30;

    namaOutput.style.fontSize = saiz + "px";
}
